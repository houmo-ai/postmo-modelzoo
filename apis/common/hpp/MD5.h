...
#define GET_UINT32(n, b, i)                                                                                                                                           \
    {                                                                                                                                                                 \
        (n) = (uint32)((uint8 *)b)[(i)] | (((uint32)((uint8 *)b)[(i) + 1]) << 8) | (((uint32)((uint8 *)b)[(i) + 2]) << 16) | (((uint32)((uint8 *)b)[(i) + 3]) << 24); \
    }
...
public:
    ...
    std::string GenerateMD5(unsigned char *buffer, int bufferlen);
...
std::string MD5::GenerateMD5(unsigned char *buffer, int bufferlen) {
