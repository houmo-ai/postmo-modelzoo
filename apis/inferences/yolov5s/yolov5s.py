...
class YoloV5:
    ...
    def scale_coords(self, coords, img0_shape, ratio_pad=None):
        ...
        if ratio_pad is None:  # calculate from img0_shape
            gain = min(self._image_size[0] / img0_shape[0], self._image_size[1] / img0_shape[1])  # gain  = old / new
            pad = (self._image_size[1] - img0_shape[1] * gain) / 2, (self._image_size[0] - img0_shape[0] * gain) / 2  # wh padding
        else:
            gain = ratio_pad[0][0]
            pad = ratio_pad[1]
