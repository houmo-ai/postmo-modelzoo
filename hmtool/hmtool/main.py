...
def main():
    ...
    # perf
    perf_parser = subparsers.add_parser("perf", parents=[parent_parser3], help="Test model performance")
    perf_parser.add_argument("--model",   "-m", type=str, required=True, help="Specify model path")
