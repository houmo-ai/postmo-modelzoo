...
本示例展示如何把量化后的YOLOv8n模型编译，部署到后摩芯片的设备上。

[TOC]

## 1.模型说明

本例使用的 YOLOv8n 实现来源 github 开源链接[https://github.com/ultralytics/assets/releases/download/v8.3.0/yolov8n.pt](https://github.com/ultralytics/assets/releases/download/v8.3.0/yolov8n.pt)。

下载模型后可使用ultralytics工具导出为onnx模型，执行命令：
```bash
pip3 install ultralytics
yolo export model=yolov8n.pt format=onnx imgsz=640,640 opset=11 simplify=True
```
...
- YOLOv8n 模型：[https://github.com/ultralytics/ultralytics/tree/v8.2.0](https://github.com/ultralytics/ultralytics/tree/v8.2.0
