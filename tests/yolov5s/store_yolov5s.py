...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        dest='model_path',
        type=str,
        default='./quant_yolov5s_without_yolo.onnx',
...
if __name__ == '__main__':
    ...
    quant_path = 'quant_yolov5s_without_yolo.onnx'
    if not os.path.exists(quant_path):
        os.system('wget http://10.10.1.53:8082/artifactory/toolchain/support/models/yolov5/quant_yolov5s_without_yolo.onnx')
    compile()
