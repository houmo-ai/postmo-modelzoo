...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Download Qwen3-8B hmm model")
    parser.add_argument("--download-dir", default="./models", help="Download directory")
    parser.add_argument("--model-size", default="8b", help="Model size")
    parser.add_argument("--context-length", default="8k", help="Context length")
    ...
    model_cfgs = {
        ...
        "modelscope_repo": {
            "repo_ids": [f"Qwen/Qwen3-{args.model_size.upper()}"],
