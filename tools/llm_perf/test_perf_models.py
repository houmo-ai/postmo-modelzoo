...
all_test_models = [
    ...
    f"{TARGET_PATH}/qwen3/hmm_xh2_qwen3_8b_256_32k_b1_1chip_2cores_v1.0.0.zip",
    f"{TARGET_PATH}/qwen3/qwen3/hmm_xh2_qwen3_14b_256_16k_b1_1chip_2cores_v1.0.0.zip",
    f"{TARGET_PATH}/qwen3/hmm_xh2_qwen3_14b_256_32k_b1_2chips_2cores_v1.0.0.zip",
    f"{TARGET_PATH}/qwen3/hmm_xh2_qwen3_30b_a3b_256_32k_b1_1chip_2cores_v1.0.0.zip",
    f"{TARGET_PATH}/qwen3-vl/hmm_xh2_qwen3-vl_30b_a3b_256_8k_b1_1chip_2cores_v1.0.0.zip",
...
for idx, model_url in enumerate(all_test_models):
    ...
    import subprocess
    args = ["../bin/llm_perf", "--prefill", perf_config["prefill"], "--decode", perf_config["decode"]]
    if visual_path is not None:
        args.append("--visual")
    ...
    log_file = f"logs/{perf_config['ModelName']}.log"
