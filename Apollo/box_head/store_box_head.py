...
def get_onnx_module():
    if not os.path.exists('box_head.zip'):
        os.system('curl -upublic:Password@123 http://10.10.1.53:8082/artifactory/hdpl_test_data/quant_models/apollo/obstacle/box_head.zip -o ./box_head.zip')
    if not os.path.exists('box_head'):
        os.system('unzip box_head.zip')
