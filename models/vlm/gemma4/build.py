...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model_name", type=str, default="gemma4-26b-a4b", help="output houmo model name")
    ...
    parser.add_argument("--context_length", type=int, default=131072, help="context length for LLM models")
