...
def get_args():
    ...
    parser.add_argument("--prefill_path", default=f"output/{HOUMO_TARGET}/gemma-4-26b-a4b_prefill.hmm")
    parser.add_argument("--decode_path", default=f"output/{HOUMO_TARGET}/gemma-4-26b-a4b_decode.hmm")
