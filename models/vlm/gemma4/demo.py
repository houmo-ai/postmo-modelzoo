...
def get_args():
    ...
    parser.add_argument("--prefill_path", default=f"output/{HOUMO_TARGET}/gemma4_26b-a4b_prefill.hmm")
    parser.add_argument("--decode_path", default=f"output/{HOUMO_TARGET}/gemma4_26b-a4b_decode.hmm")
    parser.add_argument("--vit_path", default=f"output/{HOUMO_TARGET}/gemma4_26b-a4b_visual.hmm")
