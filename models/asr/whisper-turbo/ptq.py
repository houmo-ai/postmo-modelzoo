...
# Whisper-Turbo ASR models using post-training quantization techniques.
#
...
from quant_pipeline import export_encoder_prefill, export_decoder, move_llm
