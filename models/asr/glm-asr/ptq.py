...
# GLM-ASR models using post-training quantization techniques.
#
...
def parse_args():
    ...
    parser.add_argument(
        "--model-name", type=str, default="glm-asr", help="output hmonnx model name"
    )
    parser.add_argument(
        "--out-dir",
        type=str,
        default="output/{}/hmquant".format(HOUMO_TARGET),
        help="output directory for quantized models and golden data",
    )
