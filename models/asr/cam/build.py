...
# File: build.py
# Description:
#   CAMPPlus Model Build and Test Tool - Python script for building and testing
...
def test(model_name, model_dir, output_dir, profile, batch=1, prefix=None):
    ...
    print(
        f'{model_name} get {output_num} outputs completed in {profile["get_output"]*1000:.3f} ms.'
    )
    if not result_check:
