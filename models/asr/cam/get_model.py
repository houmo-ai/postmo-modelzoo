...
# File: get_model.py
# Description:
#   Model Download Tool - Python script for downloading CAMPPlus
...
def download_raw_from_modelscope(repo_id: str, download_dir: str = "."):
    ...
    print(f"Raw model downloaded to: {local_dir}")
...
if __name__ == "__main__":
    ...
    if args.file_type == "raw":
        # Download raw model from ModelScope directly
        repo_ids = model_config.get("modelscope_repo", [])
        if not repo_ids:
            print("Error: No modelscope_repo configured in config.yaml.")
            exit(1)
        ...
        model_cfgs = {
            ...
            "model_info": {
                ...
                "ncore": ncore,
                "ndevice": ndevice,
                "quant_type": model_config.get("quant_type", ""),
                "batch": 1,
            },
            "modelscope_repo": {
                "repo_ids": model_config.get("modelscope_repo", []),
