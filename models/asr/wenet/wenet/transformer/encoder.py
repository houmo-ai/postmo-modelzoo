...
class BaseEncoder(torch.nn.Module):
    ...
    def forward_export_onnx(self, xs: torch.Tensor, masks_attn: torch.Tensor, masks_cnn: torch.Tensor) -> torch.Tensor:
        if self.global_cmvn is not None:
            xs = self.global_cmvn(xs)
        xs, pos_emb = self.embed.forward_export_onnx(xs)
        xs = self.forward_layers_export_onnx(xs, masks_attn, pos_emb, masks_cnn)
        if self.normalize_before:
            xs = self.after_norm(xs)
        return xs

    def forward_layers_export_onnx(self, xs: torch.Tensor, chunk_masks: torch.Tensor,
                       pos_emb: torch.Tensor,
                       mask_pad: torch.Tensor) -> torch.Tensor:
        for layer in self.encoders:
            xs = layer.forward_export_onnx(xs, chunk_masks, pos_emb, mask_pad)
        return xs
    ...
    def forward_layers_chunk_export_onnx(self, 
                                         xs: torch.Tensor, 
                                         pos_emb: torch.Tensor,
        ...
        for idx, layer in enumerate(self.encoders):
            xs, k_catch, v_catch, c_catch = layer.forward_chunk_export_onnx(xs, pos_emb, masks_attn, masks_cnn, args[idx*3], args[idx*3 + 1], args[idx*3 + 2], offset_start, offset_end)
            catchs.append(k_catch)
            catchs.append(v_catch)
            catchs.append(c_catch)
        return xs, *catchs
    
    def forword_chunk_export_onnx(
        self,
        xs: torch.Tensor, 
        pos_emb: torch.Tensor,
        masks_attn: torch.Tensor, 
        ...
        *args,
        ...
        if self.global_cmvn is not None:
            xs = self.global_cmvn(xs)
        xs, _ = self.embed.forward_export_onnx(xs)
        # offset_end = xs.shape[1] + offset
        xs, k_cache_0, v_cache_0, cnn_cache_0, k_cache_1, v_cache_1, cnn_cache_1, k_cache_2, v_cache_2, cnn_cache_2, k_cache_3, v_cache_3, cnn_cache_3, k_cache_4, v_cache_4, cnn_cache_4, k_cache_5, v_cache_5, cnn_cache_5, k_cache_6, v_cache_6, cnn_cache_6, k_cache_7, v_cache_7, cnn_cache_7, k_cache_8, v_cache_8, cnn_cache_8, k_cache_9, v_cache_9, cnn_cache_9, k_cache_10, v_cache_10, cnn_cache_10,  k_cache_11, v_cache_11, cnn_cache_11 = self.forward_layers_chunk_export_onnx(xs, pos_emb, masks_attn, masks_cnn, offset, offset_end, *args)
        if self.normalize_before:
            xs = self.after_norm(xs)
        return xs, k_cache_0, v_cache_0, cnn_cache_0, k_cache_1, v_cache_1, cnn_cache_1, k_cache_2, v_cache_2, cnn_cache_2, k_cache_3, v_cache_3, cnn_cache_3, k_cache_4, v_cache_4, cnn_cache_4, k_cache_5, v_cache_5, cnn_cache_5, k_cache_6, v_cache_6, cnn_cache_6, k_cache_7, v_cache_7, cnn_cache_7, k_cache_8, v_cache_8, cnn_cache_8, k_cache_9, v_cache_9, cnn_cache_9, k_cache_10, v_cache_10, cnn_cache_10,  k_cache_11, v_cache_11, cnn_cache_11
