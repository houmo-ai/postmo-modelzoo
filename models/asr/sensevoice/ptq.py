...
def parse_args():
    ...
    parser.add_argument(
        "--calib", type=str, help="Path to pre-generated calibration .pth file"
    )
    parser.add_argument(
        "--hf-dataset",
        type=str,
    ...
    parser.add_argument(
        "--hf-config", type=str, default="clean", help="Dataset config name"
    )
    parser.add_argument(
        "--hf-split", type=str, default="validation", help="Dataset split"
    )
    parser.add_argument(
        "--hf-audio-field", type=str, default="audio", help="Audio field name"
    )
    parser.add_argument(
        "--hf-streaming",
        type=bool,
    ...
    parser.add_argument(
        "--calib-samples", type=int, default=128, help="Number of calibration samples"
    )
    parser.add_argument(
        "--calib-metric",
        type=str,
