...
# File: get_model.py
# Description:
#   Download DINOv3-base model for image classification tasks.
#
...
if __name__ == "__main__":
    ...
    target = HOUMO_TARGET
    raw_path = "models/raw/onnx/dinov3_vitb16-sim.onnx"
    classifier_head_path = "models/dataset/dinov3-vitb16-imagenet-linear-head.pt"
    ...
    if not os.path.exists(classifier_head_path):
        get_file_from_jfrog(classifier_head_path, ".", ".")
