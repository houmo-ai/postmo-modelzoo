...
# File: dataset.py
# Description:
#   Dataset class for ResNet50 model.
#
...
class Dataset(ILSVRC2012):
    ...
    This class provides the dataset implementation for the ResNet50 model,
    using the ILSVRC2012 (ImageNet) validation dataset as base. It handles data loading
    and preprocessing required for the ResNet50 model evaluation.
    ...
    def __init__(self, **kwargs):
        """
        Initialize the ResNet50 dataset.
