...
def parse_args():
    ...
    parser.add_argument("--model", type=str, default="gte_Qwen2-1.5B-instruct", help="raw model dir name")
    parser.add_argument("--model-name", type=str, default="gte", help="output hmonnx model name")
    ...
    parser.add_argument("--quant-type", default="w8a8_sefp", help="quant type, default is w4a8_sefp")
    parser.add_argument("--calibration-dataset", type=str, default=None, help="customized calibrate dataset, should be a json file")
    parser.add_argument("--quant-weight", type=str, default=None, help="quant weight path, for example: gptq or quarot, if empty, use w8a8")
