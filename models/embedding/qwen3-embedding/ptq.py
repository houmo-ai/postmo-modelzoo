...
# Qwen3-Embedding-8B models using post-training quantization techniques.
#
...
def get_default_model_dir(model_config: dict) -> str:
    ...
    model_name = model_config.get("model_name", "qwen3-embedding")
...
def parse_args() -> argparse.Namespace:
    ...
    args.quant_type = first_not_none(
        args.quant_type, model_config.get("quant_type", "w4a8_ssfp")
    )
