...
if __name__ == "__main__":
    ...
    with ProcessMemoryMonitor(interval=2, quiet=True) as monitor:
        if args.stage == "build" or args.stage == "all":
            ...
            Xh2Exec.build_from_hmonnx(
                hmonnx=find_hmonnx_file(os.path.join(model_dir, "dvae"), pattern="hmquant_*part1*.onnx"),
            ...
            Xh2Exec.build_from_hmonnx(
                hmonnx=find_hmonnx_file(os.path.join(model_dir, "dvae"), pattern="hmquant_*part2*.onnx"),
