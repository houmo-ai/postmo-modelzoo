...
def get_args() -> argparse.Namespace:
    ...
    args.image_size_w = first_not_none(args.image_size_w, model_config.get("image_size_w", 672))
    args.image_size_h = first_not_none(args.image_size_h, model_config.get("image_size_h", 672))
...
if __name__ == "__main__":
    ...
    profile = {}
    visual_model_name = (
        f"{model_name}-{model_size}_visual_" f"{args.image_size_w}x{args.image_size_h}x{args.max_size_t}"
    )
