...
if __name__ == "__main__":
    ...
    if args.stage == "test" or args.stage == "all":
        ...
        test("glm-ocr_prefill", part_dir, output_dir, profile, prefix=model_name)
        part_dir = os.path.join(model_dir, "decoder")
        test("glm-ocr_decode", part_dir, output_dir, profile, prefix=model_name)
        part_dir = os.path.join(model_dir, "visual")
        test("glm-ocr_visual", part_dir, output_dir, profile, prefix=model_name)
