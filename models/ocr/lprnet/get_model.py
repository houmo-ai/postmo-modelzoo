...
# File: get_model.py
# Description:
#   Download LPRNet model for license plate recognition tasks.
#
...
if __name__ == "__main__":
    ...
    data_path = "models/dataset/base_yolov5lprnet.tar.gz"
    raw_path = "models/raw/onnx/lprnet_24x94_2dmaxpool.onnx"
