...
# File: get_model.py
# Description:
#   Download PaddleOCR-VL-1.6 model assets or precompiled HMM files.
#
...
def get_default_model_dir(model_config: dict) -> str:
    ...
    model_name = model_config.get("model_name", "paddleocr-vl-1.6").upper()
...
if __name__ == "__main__":
    ...
    context_length = first_not_none(
        args.context_length, model_config.get("context_length", "16k")
    )
