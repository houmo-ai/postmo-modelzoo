...
def move_llm(args):
    ...
    simple_batch_rename(
        ...
        "hmquant_Qwen2.5-VL-7B-Instruct-XH2a-w4a8h1_ssfp_vision",
    ...
    simple_batch_rename(
        ...
        "hmquant_Qwen2.5-VL-7B-Instruct-XH2a-w4a8h1_ssfp-llm-prefill",
        "hmquant_{}".format(args.model_name),
    )
    shutil.move(
    ...
    simple_batch_rename(
        ...
        "hmquant_Qwen2.5-VL-7B-Instruct-XH2a-w4a8h1_ssfp-llm-decode",
        "hmquant_{}".format(args.model_name),
    )
