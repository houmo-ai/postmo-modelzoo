...
# File: build.py
# Description:
#  Qwen3-VL  Model Build and Test Tool - Python script for building and testing
# Qwen3-VL models.
#
...
if __name__ == "__main__":
    ...
    if args.stage == "test" or args.stage == "all":
        ...
        test("qwen3-vl_prefill", part_dir, output_dir, profile, prefix=model_name)
        part_dir = os.path.join(model_dir, "decoder")
        test("qwen3-vl_decode", part_dir, output_dir, profile, prefix=model_name)
        part_dir = os.path.join(model_dir, "visual")
        test("qwen3-vl_visual", part_dir, output_dir, profile, prefix=model_name)
