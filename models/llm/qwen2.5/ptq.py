...
if HOUMO_TARGET == 'xh1':
    ...
    def main(args):
        ...
        shutil.move(work_dir / "hmquant/prefill/qwen2.5-7b-instruct-hf-XH2a-8k-w8a8_sefp_prefill.onnx", work_dir / "hmquant/prefill/hmquant_qwen2.5_with_act.onnx")
        shutil.move(work_dir / "hmonnx/decode", work_dir / "hmquant/decoder")
        shutil.move(work_dir / "hmquant/decoder/qwen2.5-7b-instruct-hf-XH2a-8k-w8a8_sefp_decode.onnx", work_dir / "hmquant/decoder/hmquant_qwen2.5_with_act.onnx")
