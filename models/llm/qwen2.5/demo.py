...
class HmQwen:
    ...
    def __init__(self, model_dir, prefill_length, decode_length, batch=1, nblocks=28):
        ...
        self.prefill_body_model = tcim.runtime.load(os.path.join(model_dir, "qwen2.5_prefill_body.hmm"), option = option1)
        self.prefill_head_model = tcim.runtime.load(os.path.join(model_dir, "qwen2.5_prefill_head.hmm"), option = option1)
