...
def get_default_model_dir(model_config: dict) -> str:
    ...
    model_name = model_config.get("model_name", "qwen3.6")
...
def parse_args() -> argparse.Namespace:
    # fmt: off
    parser = argparse.ArgumentParser(description="Run the Qwen3.5/Qwen3.6 Merak quant/export workflow.")
...
def main() -> None:
    ...
    # quant
    quant_output_dir = f"{args.work_dir}/qwen3.5_quant"
