...
if __name__ == '__main__':
    ...
    quant_path = "models/qwen/hmquant_qwen_20240613.zip"
    weight_path = "models/qwen/hmquant_qwen_weight_20240612.zip"
    ...
    if model_type == "quant" or model_type == "all":
        ...
        get_file_from_jfrog(weight_path)
        weight_name = os.path.basename(weight_path)
        os.system('mkdir -p ' + quant_model_dir)
        os.system('unzip -o -d ' + quant_model_dir + ' ' + weight_name)