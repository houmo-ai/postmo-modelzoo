...
TOKENIZER_PATH = "DeepSeek-R1-0528-Qwen3-8B"
...
class HmQwenXh2:
    ...
    def __init__(self, model_dir, prefill_length, decode_length, batch=1, nblocks=28):
        ...
        self.prefill = tcim.runtime.load(os.path.join(model_dir, "deepseek_prefill.hmm"), option = option1)
        self.decode = tcim.runtime.load(os.path.join(model_dir, "deepseek_decode.hmm"), option = option2)
        # set kvcache input
