...
class YoloV3(CocoDetectionModel):
    """
    YOLOv3 object detection model implementation.

    This class implements the YOLOv3 model for object detection tasks,
    ...
    def __init__(self, **kwargs):
        """
        Initialize YoloV3 model instance.
    ...
    def decode(self, outs: Dict[str, np.ndarray]) -> torch.Tensor:
        ...
        YOLOv3's anchor-based transformation with grid shifts and scaling.
    ...
    def postprocess(
        ...
        First decodes the model outputs using anchor-based transformation,
        then applies non-maximum suppression and scales the detection coordinates
