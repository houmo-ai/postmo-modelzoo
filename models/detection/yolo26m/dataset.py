...
# File: dataset.py
# Description:
#   Dataset class for YOLO26m model using COCO2017 validation set.
#
...
class Dataset(COCO2017Val):
    """
    Dataset class for YOLO26m model.

    This class inherits from COCO2017Val and is used for data processing
    in the YOLO26m object detection model. It uses the COCO2017 validation
