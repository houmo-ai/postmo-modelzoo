...
# File: get_model.py
# Description:
#   Fun-Audio-Chat model resource download tool.
#
...
"""Download and extract Fun-Audio-Chat model resources."""

import argparse
import os

from hmatc.utils.utils import first_not_none, get_houmo_version, get_model_configs, hmatc_get_file, get_file_from_jfrog
...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="where to extract downloaded archives",
    )
    parser.add_argument(
        "--source_type",
        dest="source_type",
