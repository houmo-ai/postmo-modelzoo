 ...
 * File: imagenet.hpp
 * Description:
 *   This header file defines the Imagenet class which provides access to the
 *   ImageNet dataset labels. The class contains a static map of class IDs to
 *   their corresponding human-readable names for the 1000 ImageNet classes.
 *   This is commonly used in image classification tasks for mapping model
 *   outputs to meaningful class names.
 *
...
#ifndef __APIS_COMMON_HPP_DATASET_IMAGENET_HPP__
#define __APIS_COMMON_HPP_DATASET_IMAGENET_HPP__
...
#endif  // __APIS_COMMON_HPP_DATASET_IMAGENET_HPP__
