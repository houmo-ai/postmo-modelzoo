...
output_num=3
input_name=()
output_name=('densepoint_out_softmax', 'conv_out_curb_cur_row_regx', 'conv_out_curb_last_row_regx', 'curb_out_softmax', 'conv_out_line_cur_row_regx', 'conv_out_line_last_row_regx', 'dashline_out_softmax', 'dashline_begin_regx', 'dashline_begin_regy', 'dashline_end_regx', 'dashline_end_regy', 'laneline_class_out_softmax', 'laneline_color_out_softmax', 'fork_converge_type_out_softmax', 'conv_out_fork_conv_regx', 'conv_out_fork_conv_regy')
